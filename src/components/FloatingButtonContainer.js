  ...
  return (
    <>
      <div className="floating-buttons-container">
        {/* Messages Button - only show when not on messages page */}
        {!isMessagesPage && currentUser && (
          <button
            className="floating-btn messages-btn"
